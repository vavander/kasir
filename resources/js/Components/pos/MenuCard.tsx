...
export default function MenuCard({ menu, qty, onAdd }: MenuCardProps) {
    return (
        <button
            onClick={onAdd}
            className="group relative bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden text-left hover:border-indigo-400 dark:hover:border-indigo-500 hover:shadow-md transition-all duration-150 active:scale-[0.98]"
        >
            {/* Image */}
            ...
            <div className="p-2.5">
                ...
                <div className="flex items-center justify-between mt-1.5">
                    ...
                    <div className="w-6 h-6 rounded-md bg-indigo-50 dark:bg-indigo-950 flex items-center justify-center group-hover:bg-indigo-100 dark:group-hover:bg-indigo-900 transition-colors">
