...
export default function CashierExpenseIndex({ expenses, filters }: Props) {
    ...
    useEffect(() => {
        ...
        timeout.current = setTimeout(() => {
            router.get(route('cashier.expenses.index'), { search }, { preserveState: true, replace: true });
        }, 300);
        ...
        <CashierLayout>
            ...
            <div className="p-6 space-y-6">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-0.5">Pengeluaran milik {auth.user.name}</p>
                </div>
                            ...
                            {editing ? (
                                <>
                                    <ExpenseForm
                                        ...
                                        submitRoute={route('cashier.expenses.update', editing.id)}
                                        method="put"
                                ...
                                <ExpenseForm
                                    submitRoute={route('cashier.expenses.store')}
                                    compact
                                />
                            )}
                        </div>
                                                            ...
                                                            <AlertDialogContent>
                                                                ...
                                                                <AlertDialogFooter>
                                                                    ...
                                                                    <AlertDialogAction
                                                                        ...
                                                                        onClick={() => router.delete(route('cashier.expenses.destroy', expense.id), { preserveScroll: true })}
                                                                    >
                                                                        Hapus
                                                                    </AlertDialogAction>
                                                                </AlertDialogFooter>
